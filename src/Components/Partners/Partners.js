    ...
    <div ref={props.inp_ref} className="partners">
        <div className="partenaires">
            ...
            <div className="partners_logo">
                ...
                <div className="image_container"><div className="partner_logo"><img className="scale-2prc" src="/images/logo_fondation.png" alt="logo fondation isae-supaero" /></div></div>
                <div className="image_container"><div className="partner_logo"><img className="scale-2prc" src="/images/logo_ose.jpg" alt="logo ose isae" /></div></div>
            </div>
        </div>
